...
app.use(
  cors({
    origin: [
      env.FRONTEND_ORIGIN || 'https://caltopsoft.github.io/DevHub',
      env.ADMIN_ORIGIN || 'https://caltopsoft.github.io/DevHubAdmin',
      env.EXTRA_ORIGIN || 'https://caltopsoft.github.io/DevHubAdmin',
    ].filter(Boolean),
  })
);
